...
void fit_bin(RooDataSet * ds_US, RooDataSet * ds_LS)
{
	...
	// TODO 3
	// Create PDFs
	****** *expComb = new ******("expComb","Comb background", mass, bgComb);
	****** *expRes = new ******("expRes","Res background", mass, bgRes);
	****** *sig = new ******("gauss1", "CB signal 1", mass, sig_mu, sig_sigma, sig_alpha, sig_n);
