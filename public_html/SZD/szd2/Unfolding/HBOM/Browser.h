...
//  TDirectory * topDirectory;
  ...
  vector<Double_t> Jet_true_px;
  vector<Double_t> Jet_true_py;
  vector<Double_t> Jet_true_pz;
  vector<Double_t> Jet_true_e;


  vector<Double_t> Jet_reco0_px;
  vector<Double_t> Jet_reco0_py;
  vector<Double_t> Jet_reco0_pz;
  vector<Double_t> Jet_reco0_e;

  vector<Double_t> Jet_reco1_px;
  vector<Double_t> Jet_reco1_py;
  vector<Double_t> Jet_reco1_pz;
  vector<Double_t> Jet_reco1_e;

  vector<Double_t> Jet_reco2_px;
  vector<Double_t> Jet_reco2_py;
  vector<Double_t> Jet_reco2_pz;
  vector<Double_t> Jet_reco2_e;

  vector<Double_t> Jet_reco3_px;
  vector<Double_t> Jet_reco3_py;
  vector<Double_t> Jet_reco3_pz;
  vector<Double_t> Jet_reco3_e;

  vector<Double_t> Jet_reco4_px;
  vector<Double_t> Jet_reco4_py;
  vector<Double_t> Jet_reco4_pz;
  vector<Double_t> Jet_reco4_e;

  vector<Double_t> Jet_reco5_px;
  vector<Double_t> Jet_reco5_py;
  vector<Double_t> Jet_reco5_pz;
  vector<Double_t> Jet_reco5_e;
