 # SZD HOMEWORKS 
Repository with code for SZD1 and SZD2 homeworks. Homeworks are deployed [here](https://thelittlerock.github.io/SZD/) using ***github pages*** and ***Jupyter Book***
...
```
Install SZD python virtual enviroment to Jupyter:
```
